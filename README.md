...
### 2. [2026 大學IC設計競賽初賽題實作 (光線折射模擬系統)](https://github.com/bubbleyiC/2026-IC-Design-Contest-REFRACT)
* **關鍵技術:** `Verilog`, `RTL Design`, `FSM`, `SRAM`
* **專案簡介:** 獨立實作模擬光線折射路徑之硬體加速器。設計包含自定義硬體開根號與除法器，完成有限狀態機 (FSM) 設計與記憶體存取規劃，成功通過 256 筆測資驗證，並滿足合成之時序要求。

### 2. [C++ 影像處理實務](https://github.com/bubbleyiC/Cpp_Image_Processing)
* **關鍵技術:** `C++`, `數位影像處理`
